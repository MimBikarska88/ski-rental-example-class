...
namespace SkiRental
{
    public class StartUp
    {
        /*
 * Summer has come!
 * Your friend who owns a Ski Rental business asked you to write a program to
 * help him organize his ski storage in order to be prepared for the coming winter season.
 *
 * 
 */
